...
import ir.msit87.mydigistore.helper.AnimationHelper;
import ir.msit87.mydigistore.helper.UtilityHelper;
...
//        this.textView.setFontStyle(this.mFontStyle);
        ...
        try {
            /////// darkGray /////
            this.mPrimaryBackgroundColor = a.getColor(R.styleable.PrimaryButton_backgroundColor, getResources().getColor(R.color.colorGray));
